...
// Delegate byte production to the native encoder (correct UTF-8 for all code
// points) and copy the result through the realm's global Uint8Array ctor so
// cross-realm `instanceof Uint8Array` checks still pass.
