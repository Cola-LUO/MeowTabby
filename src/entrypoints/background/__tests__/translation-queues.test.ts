...
const {
  ...
  generateTextForProviderRefMock,
  ...
  translationCacheDeleteMock,
  runStreamTextInBackgroundMock,
  getTranslatePromptMock,
} = vi.hoisted(() => ({
  onMessageMock: vi.fn<(...args: any[]) => any>(),
  ensureInitializedConfigMock: vi.fn<(...args: any[]) => any>(),
  executeTranslateMock: vi.fn<(...args: any[]) => any>(),
  generateArticleSummaryMock: vi.fn<(...args: any[]) => any>(),
  generateTextForProviderRefMock: vi.fn<(...args: any[]) => any>(),
  putBatchRequestRecordMock: vi.fn<(...args: any[]) => any>(),
  articleSummaryCacheGetMock: vi.fn<(...args: any[]) => any>(),
  articleSummaryCachePutMock: vi.fn<(...args: any[]) => any>(),
  translationCacheGetMock: vi.fn<(...args: any[]) => any>(),
  translationCachePutMock: vi.fn<(...args: any[]) => any>(),
  translationCacheDeleteMock: vi.fn<(...args: any[]) => any>(),
  runStreamTextInBackgroundMock: vi.fn<(...args: any[]) => any>(),
  getTranslatePromptMock: vi.fn<(...args: any[]) => any>(),
}))
