...
/**
 * Segmentation emits a whole WebVTT block in one answer; the default 4096
 * output tokens make long videos finish with `finishReason: "length"` and
 * fail as `output_validation_failed`. 8192 is the backend hard cap (spec §3.2).
 */
