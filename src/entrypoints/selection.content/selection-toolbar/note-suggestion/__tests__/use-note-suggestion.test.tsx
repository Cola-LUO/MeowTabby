...
function createHostedStatus(authenticated: boolean) {
  return authenticated
    ? { authenticated: true, balanceYuan: "1.0000", email: "a@b.c" }
    : { authenticated: false, balanceYuan: null, email: null }
}
...
describe("useNoteSuggestion", () => {
  ...
  it("skips silently and completes the session when the hosted account is signed out", async () => {
